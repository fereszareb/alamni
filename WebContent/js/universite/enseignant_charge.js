window.addEventListener("load", function () {
    $.ajax({
      type: "POST",
      url: "../function/universite/enseignant/enseignant_charge.jsp",
  ...
  $("#btn_search_ens").click(function () {
    ...
    $.ajax({
      type: "POST",
      url: "../function/universite/enseignant/enseignant_charge_search.jsp",
  ...
  $(document).on("click", "#btn-view", function () {
    ...
    $.ajax({
      url: "../function/universite/enseignant/enseignant_charge_data-ens.jsp",
      method: "post",
      data: { id: id },
  ...
  $(document).on("click", "#btn-delete", function () {
    ...
    $.ajax({
      url: "../function/universite/enseignant/enseignant_delete_data-ens.jsp",
      method: "post",
      data: { id: id },
      success: function (result) {
  ...
  $("#add_ens").click(function () {
    ...
    $.ajax({
      type: "POST",
      url: "../function/universite/enseignant/add_ens.jsp",
      data: {
        nom: nom,
        prenom: prenom,
        email: email,
