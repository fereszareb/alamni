...
try {
	...
	String sql = "SELECT COUNT(*) AS nbr from universite";
...
<div class="col-12 col-lg-3 col-md-6 mb-2">
	<div class="card">
		<div class="card-body">
			<div class="row">
				<div class="col-3">
					<i class="fas fa-university icon-stat-dashboard"></i>
				</div>
				<div class="col-9 text-center">
					<h5 class="card-title">Nbr Universités</h5>
					<h4 class="card-text " id="nbr_univ"><%=resultSet.getString("nbr")%></h4>
				</div>
			</div>
		</div>
	</div>
...
sql = "SELECT COUNT(*) AS nbr from enseignant";
resultSet = statement.executeQuery(sql);
while (resultSet.next()) {
%>
<div class="col-12 col-lg-3 col-md-6 mb-2">
