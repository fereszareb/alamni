...
String sql1 ="select * from post_classroom where id_classroom =" +resultSet.getString("id");
resultSet_cntn = statement_cntn.executeQuery(sql1);
if ( x== 0){
    x++;
matiere_cont =matiere_cont+"<div class='tab-pane fade show active' id='v"+resultSet.getString("id")+"' role='tabpanel' aria-labelledby='v-pills-messages-tab'><div class='row justify-content-end px-4'><div class='btn btn-alamni w-200px'  id-data='"+resultSet.getString("id")+"' data-bs-toggle='modal' data-bs-target='#add' id='add_cours'>Ajouter un cours</div>";

}else{
matiere_cont =matiere_cont+"<div class='tab-pane fade' id='v"+resultSet.getString("id")+"' role='tabpanel' aria-labelledby='v-pills-messages-tab'><div class='row justify-content-end px-4'><div class='btn btn-alamni w-200px' id-data='"+resultSet.getString("id")+"' data-bs-toggle='modal' data-bs-target='#add' id='add_cours'>Ajouter un cours</div>";
}
...
matiere_cont = matiere_cont+"<div class='row'><div class='col-12'><div class='card m-2'><div class='row p-2 px-3'><div class='col-7'><p>"+resultSet.getString("nom")+" "+resultSet.getString("prenom")+"</p></div><div class='col-5 text-end'><small>"+resultSet_cntn.getString("date")+"</small></div></div><div class='row px-4'><p>"+resultSet_cntn.getString("content")+"</p></div><div class='row px-3 pb-1'><div class='doc'><div class='card p-1'>TP_AJA_JSON.pdf</div></div></div></div></div></div>" ;
