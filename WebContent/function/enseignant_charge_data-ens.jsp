...
%>
                        ...
                        <p>Nom & Prénom : <%=resultSet.getString("nom") %> <%=resultSet.getString("prenom") %></p>
                        <p>CIN : <%=resultSet.getString("cin") %></p>
                        <p>Tel : <%=resultSet.getString("tel") %></p>
                        <p>titule : Docteur , Professeur , Ingenieur</p>
