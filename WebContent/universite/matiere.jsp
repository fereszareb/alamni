...
<body>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="matiere.jsp">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="add_ens_form">
									<div class="mb-3">
										<label for="nom-ens" class="form-label">Matière</label> <input
											type="text" class="form-control" id="matiere">
									</div>
									<div id="slect">
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-primary" id="add_matiere"
	...
	<script src="../js/universite/matiere_charge.js"></script>
